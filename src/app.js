...
class App{
    ...
    initPages() {
        ...
        <div id="main">
            ...
            <div id="title">
                人生重开模拟器（修改版）<br>
                <div style="font-size:1.5rem; font-weight:normal;">这天赋点满的人生依然不想呆了</div>
            </div>
        ...
        <div id="main">
            ...
            <button id="random" class="mainbtn" style="top: 50%;">50连抽！</button>
            <ul id="talents" class="selectlist"></ul>
            <button id="next" class="mainbtn" style="top:auto; bottom:0.1em">选择10个以下天赋然后点我</button>
        </div>
        `);
        ...
        talentPage
            ...
            .click(()=>{
                ...
                //     return;
                // }
                this.#totalMax = 50 + this.#life.getTalentAllocationAddition(Array.from(this.#talentSelected).map(({id})=>id));
